  ...
  return (
    <section id="services" className="section-padding bg-dark">
      <div className="container mx-auto">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-4 text-light">Our <span className="gradient-text">Services</span></h2>
        ...
        >
          {serviceData.map((service, index) => (
            ...
            >
              <div className={`bg-gradient-to-r from-primary-500 to-secondary-300 text-light p-6 flex items-center space-x-4`}>
                <div className="bg-light/20 rounded-full p-3 flex items-center justify-center">
                  {service.icon}
                </div>
                <h3 className="font-bold text-xl text-light">{service.title}</h3>
              </div>
