            ...
            <div className="glass-card rounded-xl p-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">hello@wingsmedia.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">123 Creative Blvd, Digital City, CA 90210</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-10">
                ...
                <div className="flex space-x-3">
                  <a href="#" className="bg-primary-100 hover:bg-primary-200 text-primary-600 p-3 rounded-full transition-all">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    <button
                      ...
                      className={`w-full py-3 px-6 rounded-lg bg-gradient-to-r from-primary-500 to-accent-600 text-white font-medium text-lg hover:shadow-lg transition-all ${
