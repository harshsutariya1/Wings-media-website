  ...
  return (
    <section id="portfolio" className="section-padding bg-gray-50">
      <div className="container mx-auto">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-4">Our <span className="gradient-text">Portfolio</span></h2>
        ...
        >
          {filteredItems.map((item, index) => (
            ...
            >
              <div className={`${item.imageClass} h-60 flex items-center justify-center`}>
